 ...
 * @author pc
 */
@WebServlet(name = "CancelRequestController", urlPatterns = {"/CancelRequestController"})
public class CancelRequestController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            booking.BookingDAO dao = new BookingDAO();
            if (dao.deleteBooking(id, dto.getUserid())) {
                request.setAttribute("USER_ALERT", "Cancle request to " + name + " successfully!");
            }
        } catch (Exception e) {
        } finally {
